...
////            {
////                Console.WriteLine(@"Jäät nälkäiseksi ja vauhtisi hidastuu. Aika kuluu suhteettomia määriä! Toivottavasti
////ehdit ajoissa hakemaan portfolion.");
////            }
...
////{
////Console.WriteLine(@"Kannatti ottaa riski. Valkoinen paita sopii tilanteeseen kuin tilanteeseen. Pidä
////kuitenkin kiirettä. Haastatteluun on aikaa enää hetki, eikä sinulla ole vielä portfoliota!");

////}

////else if (input5 == "b" || input5 == "B" || input5 == "c" || input5 == "C")
////{
...
////Koira reagoi sinuun vahvasti ja poliisit pysäyttävät sinut ja tutkivat reppusi.Repusta löytyy liekkipipo, minigrip-pussillinen metamfetamiinia sekä piipun, 
...
////            }
////            if (input11 == "a" || input11 == "A" || input11 == "b" || input11 == "B" || input11 == "c" || input11 == "C")
////            {
////                Console.WriteLine("Poliisit vievät sinut putkaan jonka vuoksi myöhästyt työhaastattelusta. GAME OVER");
////            }

////            Tapahtuma tarina12 = new Tapahtuma("Portfolio", "Vihdoin saavut Siskon asuntoon Töölöön. Sisko ystävällisesti tarjoutuu keittämään kahvit, mutta kieltäydyt kohteliaasti. Haluat saada portfolion mahdollisimman nopeasti ja jatkaa matkaa. Otat portfolion ja katsot kelloa pois lähtiessäsi. Olet nyt Ruusulankadun Fafasin kohdalla. Työhaastattelu on Makkaratalossa keskustassa. Matkaa jatkaaksesi sinulla on kolme vaihtoehtoa. A) Jatkaa matkaa ratikalle. B) Lähteä kävelemään Makkaratalolle. C) Etsiä kaupunkipyörä ja pyöräillä Makkaratalolle.\nMitä haluat tehdä? : ");


////Tapahtuma tarina13 = new Tapahtuma("Huumeet", @"Ryhdyt kaivelemaan varmistaaksesi että sinulla on kaikki tarvittava mukana, kun löydät repustasi liekkipipon,
////minigrip-pussillisen metamfetamiinia sekä piipun, johon on kaiverrettu nimikirjaimet: J.S. Tajuat heti, että reppusi on vaihtunut Siltsun repun kanssa. Ryhdyt miettimään mitä teet huumeiden kanssa.");

////Console.WriteLine("A) Päätät ottaa yhteyttä Siltsuun voidaksesi palauttaa Siltsun repun ja saadaksesi oman repun takaisin");
////            Console.WriteLine("B) Päätät jatkaa matkaasi työhaastatteluun väärästä repusta huolimatta.");
////            Console.WriteLine("C) Näet oivan mahdollisuuden tienata rahaa myymällä huumeet. Päätät suunnata Kallioon etsimään ostajaa");
...
////            {
////                Console.WriteLine(@"Olet juuri etsimässä Siltsua Facebookista, kun puhelimesi soi. Vastaat puhelimeen ja kuulet puhelimessa olevan Siltsun. 
////    Hän on myös havainnut reppujen vaihtumisen ja sopii tapaavansa sinut läheisessä puistossa repun vaihdon merkeissä");
////            }

////            if (input13 == "b" || input13 == "B")
////            {
////                Console.WriteLine(@"Piilotat Siltsun paheet syvemmälle reppuun ja laitat portfoliosi päällimmäiseki. Lähdet suuntaamaan kohti työhaastattelua kävellen.");
////            }

////              if (input13 == "c" || input13 == "C")
////            {
////                Console.WriteLine(@"Googletat pirin katukauppahinnan ja suuntaat kohti metroasemaa tarkoituksenasi matkustaa Kallioon");
////            }
////            if (input13 == "b" || input13 == "B")
////            {Tapahtuma tarina14 = new Tapahtuma("Siltsun repun palautus", @"Saavut läheiseen puistoon ja näet Siltsun odottelevan puun alla ympärilleen pälyillen. Vaihdatte reput nopeasti ja
////Siltsu tarkistaa oman reppunsa sisällön. Kaiken sieltä löytyessä hän halaa ja kiittää sinua. Poistuessaan paikalta hän toivottaa sinulle onnea työhaastatteluun. Mietit mitä seuraavaksi");

////Console.WriteLine("A) Lähdet kävelemään kohti työhaastattelua");
////            Console.WriteLine("B) Päätät jatkaa matkaasi työhaastatteluun raitiovaunulla");
...
//                //				"Repusta löytyy liekkipipo, minigrip-pussillinen metamfetamiinia sekä piipun, johon on kaiverrettu nimikirjaimet: J.S" +
